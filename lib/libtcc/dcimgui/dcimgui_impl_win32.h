...
extern CIMGUI_IMPL_API LRESULT cImGui_ImplWin32_WndProcHandler(HWND hWnd,
                                                               UINT msg,
                                                               WPARAM wParam,
                                                               LPARAM lParam);
...
CIMGUI_IMPL_API float cImGui_ImplWin32_GetDpiScaleForHwnd(
    void* hwnd);  // HWND hwnd
CIMGUI_IMPL_API float cImGui_ImplWin32_GetDpiScaleForMonitor(
    void* monitor);  // HMONITOR monitor

// Transparency related helpers (optional) [experimental]
// - Use to enable alpha compositing transparency with the desktop.
// - Use together with e.g. clearing your framebuffer with zero-alpha.
CIMGUI_IMPL_API void cImGui_ImplWin32_EnableAlphaCompositing(
    void* hwnd);  // HWND hwnd
